...
var _apiDataJs = require("./api-data.js");
...
input.addEventListener("keyup", async ()=>{
    removeElements();
    if (input.value.legnth < 4) return false;
...
button.addEventListener("click", getResult = async ()=>{
    if (input.value.trim().legnth < 1) alert("You must enter a name");
...
},{"./api-data.js":"h1EKR"}],"h1EKR":[function(require,module,exports) {
//export let ts = new Date().getTime();
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ts", ()=>ts);
parcelHelpers.export(exports, "publicKey", ()=>publicKey);
parcelHelpers.export(exports, "privateKey", ()=>privateKey);
parcelHelpers.export(exports, "hashVal", ()=>hashVal);
const ts = "1688196739436";
const publicKey = "dff69c3ac4cc18190c306429cdb47138";
const privateKey = "2131e42cbbac08c7239c71f4c144cf86dc762400";
const hashVal = "112347d7abd194fc3746cf72563f182c";
...
},{}]},["gAoaA","6rimH"], "6rimH", "parcelRequirefdb6")
